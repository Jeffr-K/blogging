...
The existing Equivalence you want to use as a base (Equivalence.number in this case, for comparing numbers).
A function that extracts the value used for the equivalence check from your data structure ((user: User) => user.id in this case).
