...
The @opentelemetry/api package is a peer dependency of @effect/opentelemetry. If your package manager does not automatically install peer dependencies, you must add it manually.
