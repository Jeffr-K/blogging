...
Effect.catchAll only handles recoverable errors. It will not recover from unrecoverable defects. See Effect.catchAllCause for handling all types of failures.
