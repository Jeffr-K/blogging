...
React Query는 "서버에서 데이터를 가져오고, 캐싱하고, 동기화하는" 모든 복잡성을 대신 처리해줍니다.
...
React Query를 쓰면 이 모든 것이 기본으로 제공됩니다. 개발자는 "어떤 데이터를 어디서 가져오는지"만 정의하면 됩니다.
